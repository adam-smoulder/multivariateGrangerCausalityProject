...
MVGC_TimeDomain;
cd ..
saveas(figure(66), strcat('adamFigsAndData/IndividualCues/conditional/~timeDomain/',cueString,'/time_',cueString,'_',monkey_Date,'_intarg'));
clf 
close all
save(strcat('adamFigsAndData/IndividualCues/conditional/~timeDomain/',cueString,'/time_',cueString,'_',monkey_Date,'_intarg'));
cd AlteredScripts
...
MVGC_TimeDomain;
cd ..
saveas(figure(66), strcat('adamFigsAndData/IndividualCues/conditional/~timeDomain/',cueString,'/time_',cueString,'_',monkey_Date,'_outtarg'));
clf 
close all
save(strcat('adamFigsAndData/IndividualCues/conditional/~timeDomain/',cueString,'/time_',cueString,'_',monkey_Date,'_outtarg'));
cd AlteredScripts

% saccade, in - out
disp('...')
disp('saccade, in - out')
inTargFileString = strcat('time_',cueString,'_',monkey_Date,'_intarg');
outTargFileString = strcat('time_',cueString,'_',monkey_Date,'_outtarg');
subtractorExtractor_TimeDomain;
cd ..
saveas(figure(66), strcat('adamFigsAndData/IndividualCues/conditional/~timeDomain/',cueString,'/time_',cueString,'_',monkey_Date,'_in-out'));
clf 
close all
save(strcat('adamFigsAndData/IndividualCues/conditional/~timeDomain/',cueString,'/time_',cueString,'_',monkey_Date,'_in-out'));
cd AlteredScripts
...
saccFileString = strcat('time_sacclfp_',monkey_Date,'_intarg');
targFileString = strcat('time_targlfp_',monkey_Date,'_intarg');
plotForFigure_TimeDomain;
cd ..
saveas(figure(66), strcat('adamFigsAndData/Figure_Targ&SaccLFP/~timeDomain/',monkey_Date,'/',num2str(maxAxisOverride),'limit/cond_intarg'));
clf 
close all
cd AlteredScripts
...
saccFileString = strcat('time_sacclfp_',monkey_Date,'_outtarg');
targFileString = strcat('time_targlfp_',monkey_Date,'_outtarg');
plotForFigure_TimeDomain;
cd ..
saveas(figure(66), strcat('adamFigsAndData/Figure_Targ&SaccLFP/~timeDomain/',monkey_Date,'/',num2str(maxAxisOverride),'limit/cond_outtarg'));
clf 
close all
cd AlteredScripts
...
saccFileString = strcat('time_sacclfp_',monkey_Date,'_in-out');
targFileString = strcat('time_targlfp_',monkey_Date,'_in-out');
plotForFigure_TimeDomain;
cd ..
saveas(figure(66), strcat('adamFigsAndData/Figure_Targ&SaccLFP/~timeDomain/',monkey_Date,'/',num2str(maxAxisOverride),'limit/cond_in-out'));
clf 
close all
cd AlteredScripts

% create maxAxisOverride = 0.5 folder
maxAxisOverride = 0.05;
eval(strcat('mkdir ../adamFigsAndData/Figure_Targ&SaccLFP/~timeDomain/',monkey_Date,'/',num2str(maxAxisOverride),'limit'));
